      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          <div className="col-span-2">
            ...
            <p className="text-card/70 text-sm leading-relaxed mb-4 max-w-xs">
          ...
          <div>
            <h3 className="text-xs font-semibold text-card uppercase tracking-wider mb-3">Product</h3>
          ...
          <div>
            <h3 className="text-xs font-semibold text-card uppercase tracking-wider mb-3">Company</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="text-xs font-semibold text-card uppercase tracking-wider mb-3">Legal</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="text-xs font-semibold text-card uppercase tracking-wider mb-3">Support</h3>
            <ul className="space-y-2">
