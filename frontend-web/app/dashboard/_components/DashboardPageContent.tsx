    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10">
        <div className="bg-card border border-border rounded-xl p-8 text-center">
          ...
          <p className="text-muted-foreground">Your role (&quot;{ROLE_LABELS[primaryRole] ?? primaryRole}&quot;) does not have a dashboard. Contact your society committee to get the correct role assigned.</p>
        </div>
      </div>
    );
  }
