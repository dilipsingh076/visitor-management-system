...
import { Badge, Button, Card, CardContent, CardHeader, StatCardSkeleton, PageHeader, Alert, Avatar, EmptyState } from "@/components/ui";
        ...
        {isLoading ? (
          ...
          <Card variant="outlined">
            <EmptyState
              ...
              description="Add maintenance staff for quick contact"
            />
          </Card>
        ) : (
