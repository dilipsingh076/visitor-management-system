...
import { PageHeader, Button, Input, Avatar, EmptyState } from "@/components/ui";
        ...
        <div className="divide-y divide-border">
          {loading ? (
            ...
            <EmptyState
              ...
              title="No blacklisted visitors"
              description="Blacklisted visitors will be denied entry at the gate"
            />
          ) : (
